...
exports.JobResultFragmentDoc = (0, graphql_tag_1.default) `
...
exports.GetProjectDocument = (0, graphql_tag_1.default) `
  ...
  project(path: $path) {
    ...
    `;
exports.RunJobDocument = (0, graphql_tag_1.default) `
...
exports.GetJobDocument = (0, graphql_tag_1.default) `
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const link = `https://zeet.co/repo/${projectId}/jobs/${(_b = job === null || job === void 0 ? void 0 : job.runJob) === null || _b === void 0 ? void 0 : _b.id}`;
            ...
            if (wait) {
                ...
                while (!done) {
                    const result = yield sdk.GetJob({
                        repo: projectId,
                        job: (_c = job === null || job === void 0 ? void 0 : job.runJob) === null || _c === void 0 ? void 0 : _c.id
                    });
                    if (((_f = (_e = (_d = result.currentUser) === null || _d === void 0 ? void 0 : _d.repo) === null || _e === void 0 ? void 0 : _e.jobRun) === null || _f === void 0 ? void 0 : _f.state) === graphql_1.JobRunState.JobRunRunning) {
                        core.info('job executing...');
                    }
                    else if (((_j = (_h = (_g = result.currentUser) === null || _g === void 0 ? void 0 : _g.repo) === null || _h === void 0 ? void 0 : _h.jobRun) === null || _j === void 0 ? void 0 : _j.state) ===
                        graphql_1.JobRunState.JobRunSucceeded) {
                        core.info('job succeeded');
                        done = true;
                    }
                    else if (((_m = (_l = (_k = result.currentUser) === null || _k === void 0 ? void 0 : _k.repo) === null || _l === void 0 ? void 0 : _l.jobRun) === null || _m === void 0 ? void 0 : _m.state) === graphql_1.JobRunState.JobRunFailed) {
